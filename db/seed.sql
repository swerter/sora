...
INSERT into passwords (user_id, username, password) values (1, 'test@test.net', '$2b$12$s4tZlMwI3JqJN0gVuGfRxOYA3cWZsCxSnioD5jgwODgJ6S5u6Kdt6') ON CONFLICT (username) DO NOTHING;
